  ...
  "components": {
    "securitySchemes": {
      ...
      "EtapiBasicAuth": {
        "type": "http",
        "scheme": "basic",
        "description": "Basic Auth where username is arbitrary string (e.g. \"trilium\", not checked),  username is the ETAPI token.  To emphasize, do not use Trilium password here (won't work), only the generated ETAPI token (from Options -> ETAPI)\n"
      }
    },
    "schemas": {
      "CreateNoteDef": {
